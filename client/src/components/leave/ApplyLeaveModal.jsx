            ...
            <form onSubmit={handleSumit} className='p-6 space-y-5'>
                ...
                <div>
                    ...
                    <select name="type" required>
                        ...
                        <option value="CASUAL">Casul Leave</option>
                ...
                {/* duration */}
                    ...
                    <div>
                        <l1abel className='flex items-center gap-2 text-sm font-medium text-slate-700 mb-2'>
                ...
                <div>
                      <l1abel className='text-sm font-medium text-slate-700 mb-2 block'>
                        Reason 
                    </l1abel>
                    <textarea name="reason" readOnly rows={3} className='resize-none' placeholder='Briefly describe why you need this leave...'/>
                </div>
                ...
                {/* buttons  */}
                    ...
                    <div className='flex gap-3 pt-2'>
                        ...
                        <button disabled={loading} type="submit" className="btn-primary flex flex-1 items-center justify-center gap-2"> {loading ? ( <Loader2 className="w-4 h-4 animate-spin" />) : ( <Send className="w-4 h-4" />  )}{loading ? "Submitting..." : "Submit"}</button>
                    </div>
