...
const ProfileForm = ({ initialData, onSuccess }) => {
  ...
  return (
    ...
    >
      <h2 className="flex items-center gap-2 text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-50 text-slate-400 cursor-not-allowed border border-slate-200 rounded-lg px-3 py-2"
            />
          </div>
