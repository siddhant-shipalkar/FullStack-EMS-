...
import LeaveHistroy from "../components/leave/LeaveHistroy"
...
const Leave = () => {
  ...
  const isAdmin = false // Change this to false to test user view
  ...
  <LeaveHistroy leaves={leaves} isAdmin={isAdmin} onUpdate={fetchLeaves} />
  <ApplyLeaveModal open={showModal} onClose={()=>setShowModal(false)} onSuccess={() => { setShowModal(false); fetchLeaves(); }} />
    </div>
